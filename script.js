...
let userText = null;
const API_KEY = "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"; // Paste your API key here 
...
const getChatResponse = async (incomingChatDiv) => {
    ...
    const requestOptions = {
        ...
        headers: {
            ...
            "Authorization": `Bearer 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`
        },
        body: JSON.stringify({
